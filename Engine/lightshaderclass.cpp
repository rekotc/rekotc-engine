...
bool LightShaderClass::Render(ID3D11DeviceContext* deviceContext, int vertexCount, int instanceCount, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix,
...
bool LightShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	//modificare questo ogni volta si aggiungono nuove informazioni da passare allo shader
...
void LightShaderClass::RenderShader(ID3D11DeviceContext* deviceContext, int vertexCount, int instanceCount)
{
	...
	//vertexCount contiene il numero di vertici del SINGOLO modello
	//instanceCount contiene il numero di istanze di quel modello che voglio vengano renderizzate

//	deviceContext->UpdateSubresource(m_instanceBuffer, 0, NULL, &tempTreeInstDat[0], 0, 0);
